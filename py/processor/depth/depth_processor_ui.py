...
class ImageToDepthWithModel:
    ...
    def run(self, depth_model, image, greyscale):
        out = op.image_to_depth_with_model(depth_model, image, greyscale)
        return (out,)
        ...
        return {"required":
                {
                    ...
                    "depth_min": ("FLOAT", {"default": 0, "min": 0, "max": 1, "step": 0.01}),
                    "depth_max": ("FLOAT", {"default": 1, "min": 0, "max": 1, "step": 0.01}),
